...
module.controller('customersCtrl', function ($scope, $http) {
    ...
    $scope.deviceinfoclick = function () {
        $("#projectsetting").hide("slide", function () {
            $("#deviceinfo").show("slide", function () {
                //$("#passwordName").focus();
            });
        });
    };

    $scope.projectsettingclick = function () {
        $("#deviceinfo").hide("slide", function () {
            $("#projectsetting").show("slide", function () {
                //$("#passwordName").focus();
            });
        });
    };
